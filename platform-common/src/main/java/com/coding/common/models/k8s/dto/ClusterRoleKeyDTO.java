...
@Data
@Schema(description = "ClusterRole 查询/删除请求参数")
public class ClusterRoleKeyDTO {
    ...
    @Schema(description = "ClusterRole 名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "admin")
    private String name;
